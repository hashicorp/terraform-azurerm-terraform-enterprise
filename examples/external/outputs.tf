output "active_active" {
  ...
  description = "The outputs of the external module"
...
output "login_url" {
  value       = module.external.tfe_application_url
  description = "The URL to the TFE application"
}

output "health_check_url" {
  value       = "${module.external.tfe_application_url}/_health_check"
  description = "The URL with path to access the TFE instance health check"
}

output "iact_url" {
  value       = "${module.external.tfe_application_url}/admin/retrieve-iact"
  description = "The URL with path to access the TFE instance Retrieve IACT"
}

output "initial_admin_user_url" {
  value       = "${module.external.tfe_application_url}/admin/initial-admin-user"
