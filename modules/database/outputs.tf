output "database_server_id" {
  value       = azurerm_postgresql_flexible_server.tfe_pg.id
  description = "The resource ID of the TFE PostgreSQL server"
}

output "database_server_name" {
  value       = azurerm_postgresql_flexible_server.tfe_pg.name
  description = "The name of the TFE PostgreSQL server"
}

output "database_server_fqdn" {
  value       = azurerm_postgresql_flexible_server.tfe_pg.fqdn
...
output "database_id" {
  value       = azurerm_postgresql_flexible_server_database.tfe_pg_db.id
  description = "The resource ID of the TFE PostgreSQL database"
}

output "database_name" {
  value       = azurerm_postgresql_flexible_server_database.tfe_pg_db.name
