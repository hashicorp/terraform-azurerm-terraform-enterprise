output "tfe_license" {
  value = var.tfe_license == null ? {
    ...
    id   = azurerm_key_vault_secret.tfe_license[0].value
  }
...
output "private_key_pem" {
  value = var.private_key_pem == null ? {
    ...
    id   = azurerm_key_vault_secret.private_key_pem[0].value
  }
...
output "chained_certificate_pem" {
  value = var.chained_certificate_pem == null ? {
    ...
    id   = azurerm_key_vault_secret.chained_certificate_pem[0].value
  }
...
output "proxy_public_key" {
  value = var.proxy_public_key == null ? {
    ...
    id   = azurerm_key_vault_secret.proxy_public_key[0].value
  }
...
output "proxy_private_key" {
  value = var.proxy_private_key == null ? {
    ...
    id   = azurerm_key_vault_secret.proxy_private_key[0].value
  }
...
output "ca_certificate" {
  value = var.ca_certificate == null ? {
    ...
    id   = azurerm_key_vault_secret.ca_certificate[0].value
  }
...
output "ca_private_key" {
  value = var.ca_private_key == null ? {
    ...
    id   = azurerm_key_vault_secret.ca_private_key[0].value
  }
...
output "bastion_public_key" {
  value = var.bastion_public_key == null ? {
    ...
    id   = azurerm_key_vault_secret.bastion_public_key[0].value
  }
...
output "bastion_private_key" {
  value = var.bastion_private_key == null ? {
    ...
    id   = azurerm_key_vault_secret.bastion_private_key[0].value
  }
