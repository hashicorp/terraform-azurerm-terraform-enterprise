...
variable "mitmproxy_ca_certificate_secret" {
  default     = null
  description = "The identifier of a secret comprising a Base64 encoded PEM certificate file for the mitmproxy Certificate Authority. For Azure, the secret resides in Azure Key Vault."
  type        = string
}

variable "mitmproxy_ca_private_key_secret" {
  default     = null
  description = "The identifier of a secret comprising a Base64 encoded PEM private key file for the mitmproxy Certificate Authority. For Azure, the secret resides in Azure Key Vault."
  type        = string
}
