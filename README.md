...
| `ca_cert_secret_name`            | Name of the PEM formatted SECRET of the CA certificate found in Azure Key Vault                                            | **Optional** <br>The value for this secret will be added to the system's trusted CA repository.<br><br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
